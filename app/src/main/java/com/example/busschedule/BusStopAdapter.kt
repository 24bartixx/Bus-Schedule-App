...
class BusStopAdapter(private val onItemClicked: (Schedule) -> Unit) : ListAdapter<Schedule, BusStopAdapter.BusStopViewHolder>(DiffCallback) {
    ...
    // override and implement onCreateViewHolder() and set the onClickListener to call onItemClicked()
    ...
    // creating DiffCallback object to check whether the list stays the same
    companion object {
